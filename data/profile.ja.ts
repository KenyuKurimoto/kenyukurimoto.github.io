...
export const profileJa: ProfileData = {
  ...
  about: [
    ...
    "1つは「フィジカルAI領域」。学生時代より深層学習・画像認識に取り組んできた経験を基盤として、AIを活用したサービスロボットの実装と社会展開に本格的に向き合いたいと考えています。",
    "もう1つは「ソフトウェアインフラとロボットの連携」。今後需要が増すサービスロボットが社会に受容されるためには、ロボット単体の機能開発だけでなく、ロボットが都市スケールのシステムの一部として機能するためのソフトウェア基盤の構築が不可欠です。物理インフラや施設・都市の上位システムとスムーズに連携できる仕組みを整えることに今後も取り組んでいきます。",
  ],
  contact: {},
  skills: [
    {
